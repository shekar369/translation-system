...
const JobDetails: React.FC<JobDetailsProps> = ({ jobId, token, onBack, onEdit }) => {
  ...
  const downloadArtifact = async (artifact: JobArtifact) => {
    try {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium">{job.targetLanguages.length}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Artifacts</span>
                    <span className="font-medium">{job.artifacts.length}</span>
                  </div>
                  <div className="flex items-center justify-between">
        ...
        {activeTab === 'files' && (
          ...
          >
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Files ({job.files.length})</h2>
            </div>
        ...
        {activeTab === 'artifacts' && (
          ...
          >
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Results & Artifacts ({job.artifacts.length})</h2>
            </div>
            <div className="divide-y divide-gray-200">
        ...
        {activeTab === 'activity' && (
          ...
          >
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Activity Log ({job.events.length})</h2>
            </div>
            <div className="divide-y divide-gray-200">
